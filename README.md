...
My background combines deep legacy systems knowledge (Oracle, PL/SQL, xBase/Clipper, BASIC, COBOL) with modern SQL and Python-based data processing techniques. I am currently focused on PostgreSQL migration, Python data transformation, JSON handling and AI-assisted code evaluation workflows.
